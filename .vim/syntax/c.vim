...
syn match COperator display "::"
hi cOperator  ctermfg=cyan
syn match cFenhaoDouhao display "[;,]"
hi cFenhaoDouhao ctermfg=yellow

syn keyword cType Status ElemType uint uchar  
syn keyword cConstant ERROR OVERFLOW DONE
